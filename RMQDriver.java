...
//	    break;
	...
	int[] range = {10_000_000, 100_000_000, 200_000_000, 400_000_000};
	int begin = 1;
	...
	for (int r = 0; r < range.length; r++) {
		...
		System.out.println("Average Query time for Choice: " + choice + "\n" + timer);
		System.out.println("Current range is " + range[r]);
	}
	...
	private static void verify(int[] arr, int i, int j, int result){
		...
		if (min != result){
			...
			System.exit(1);
		} else System.out.println("min verified");
	}
